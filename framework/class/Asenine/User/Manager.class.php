...
class Manager
{
	...
	{
		$query = DB::prepareQuery("INSERT INTO Asenine_Users (ID, isEnabled, timeCreated, username, passwordCrypto) VALUES(NULL, 0, UNIX_TIMESTAMP(), NULL, %s)", \Asenine\User::createCrypto());
	...
	public static function setPassword($userID, $password)
	{
		...
		$passwordHash = \Asenine\User::createHash($password, $crypto);
	...
	{
		$query = DB::prepareQuery("UPDATE Asenine_Users SET passwordCrypto = %s WHERE ID = %u", $crypto, $userID);
